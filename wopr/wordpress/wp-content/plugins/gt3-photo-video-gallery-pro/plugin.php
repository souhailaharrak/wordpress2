		...
		public function mainActions(){
			...
			add_action('admin_init', function(){
				...
				if ($redirect) {
					...
					wp_redirect(menu_page_url('gt3_photo_gallery_intro', false));
				}
			});
...
//				), 10, 2 );
		...
		private function inlineActions(){
			...
			add_filter('gt3pg_admin_help', function(){
				return 'https://gt3wpgallery.com/kb/';
			});
...
//								);
		...
		public function wp_enqueue_scripts(){
			...
			wp_register_script('gt3pg_pro_frontend', $this->rooturl.'dist/js/deprecated.js', array(
				'blueimp-gallery.js',
				'wp-i18n',
				'imagesloaded',
