                ...
                , function(response){
                    ...
                    if (response.length > 0 && response.match(/gt3_mark/gi)) {
                        ...
                        if (i > 10) {
                           ...
                           // parent.parents('fieldset.wbc_importer.redux-field').find('.gt3_woo_demo_import_btn').show('slow');

                            window.onbeforeunload = null;

                            if (jQuery('.gt3_woo_demo_import_btn').length && confirm('Do you want to import WooCommerce products?\n' +
                                'If yes, you will be redirected to WooCoommerce importer.')) {
                                jQuery('.gt3_woo_demo_import_btn a').get(0).click();
                            } else {
