...
// edit menu walker
add_filter( 'wp_edit_nav_menu_walker', 'gt3_edit_walker', 15, 2 );
...
function gt3_edit_walker($walker,$menu_id) {
	...
	if ( !did_action('wpda-builder/mega-menu/enable') ) {
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
	    ...
	    <li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode(' ', $classes ); ?>">
	        ...
	        <div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
	            ...
	            <p class="field-custom description description-one_third field-menu-item-label_text gt3_mega-menu_item">
				...
				<p class="field-custom description description-one_third field-menu-item-label_bg_color gt3_mega-menu_item">
				...
				<p class="field-custom description description-one_third field-menu-item-label_color gt3_mega-menu_item">
				...
				<p class="field-custom description description-wide field-menu-item-megamenu gt3_mega-menu_item">
	                <?php
	                $value = $item->megamenu;
	            ...
	            <p class="field-custom description description-wide field-menu-item-show_title gt3_mega-menu_item">
	                <?php
	            ...
	            <p class="field-custom description description-wide field-menu-item-background_image gt3_mega-menu_item">
				...
				<p class="field-custom description description-thin field-menu-item-padding_left gt3_mega-menu_item">
				...
				<p class="field-custom description description-thin field-menu-item-padding_right gt3_mega-menu_item">
				...
				<p class="field-custom description description-wide field-menu-item-sidebar gt3_mega-menu_item">
